...
from src.v3.nesting import Model, adda, addsolver
...
apogee = m#addsolver(m, name='apogee', idbyname=idbyname)
...
materials = m#addsolver(m, name='materials', idbyname=idbyname)
...
aero = m#addsolver(m, name='aerodynamics', idbyname=idbyname)
...
D = adda(aero, 'D', L_0-W_0, unit='N')
C_D = Par('C_D', 0.47)
vr = Var('v', 6, 'm/s')
A_0 = adda(aero, 'A_0', 2*D/(C_D*rho_0*vr**2))

geom = m#addsolver(m, name='geometry', idbyname=idbyname)
