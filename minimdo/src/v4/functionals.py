from src.v2.execution import sympy_fx_inputs
from src.v2.transformations import partial_inversion
from src.v4.execution import EncodedFunctionContainer
from src.v4.execution import EncodedFunction
from src.v4.arghandling import Encoding
from src.v4.arghandling import decode, encode, merge_encoders
from src.v4.arghandling import flatten_args
...
def encode_sympy(sympexpr, named_output=None, single_output=False):
    ...
    if named_output is not None:
        output_encoder = Encoding((named_output,))
    encoded_function = EncodedFunction(fx, Encoding(inputs), output_encoder)
